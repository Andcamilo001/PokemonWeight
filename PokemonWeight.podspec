...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PokemonWeight.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/camilo.lezcanor@pragma.com.co/PokemonWeight'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'camilo.lezcanor@pragma.com.co' => 'andcamilo001@gmail.com' }
  s.source           = { :git => 'https://github.com/camilo.lezcanor@pragma.com.co/PokemonWeight.git', :tag => s.version.to_s }
